...
Like mentioned earlier, some tricks were used to obtain the daily data from the website of NCDC. The NCDC uploads the cumulative data on daily basis, so each day, the data were scrapped and then the daily incidemnce were recorded. For examble, below is the data scrapped from the website on March 15, 2021.
