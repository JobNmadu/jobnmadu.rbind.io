...
png("img/raw000.png", width=1200, height=800)
...
png("img/state05.png", width=1200, height=800)
...
png("img/state06.png", width=1200, height=800)
...
png("img/state10.png", width=1200, height=800)
...
DD <- niz[, c(1,2)]
'Spline with knots' <- MachineLearningMetrics(Observed = DD, yvalue = DD[, 2], Model = fit0, K =2, Name = "Nil", Form = "LM", kutuf = 0, TTy = "Number")
'Spline without knots' <- MachineLearningMetrics(Observed = DD, yvalue = DD[, 2], Model = fit, K =2,  Name = "Nil", Form = "LM", kutuf = 0, TTy = "Number")
'Smooth spline' <- MachineLearningMetrics(Observed = DD, yvalue = DD[, 2], Model = fit1, K =2,  Name = "SMOOTH", Form = "LM", kutuf = 0, TTy = "Number")
ARIMA <- MachineLearningMetrics(Observed = DD, yvalue = DD[, 2], Model = fita, K =2,  Name = "ARIMA", Form = "LM", kutuf = 0, TTy = "Number")
'Quardratic polynomial' <- MachineLearningMetrics(Observed = DD, yvalue = DD[, 2], Model = fitpi, K =2,  Name = "QUADRATIC", Form = "LM", kutuf = 0, TTy = "Number")
