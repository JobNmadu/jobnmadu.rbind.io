...
`r kableExtra::kable_styling(RMSE_fk, "striped", position = "center")`  
_Refer to Table 2 and Table 3 as well as Fig. 18-20 for more details on how the estimates and forecasts were obtained._ 
...
![Fig. 1a Daily observed cases of COVID-19 in Nigeria](img/raw000.svg)
  
![Fig. 2 Perecentages and previous days differences of COVID-19 in Nigeria `r casesstarts`](img/state05.svg)
  
![Fig. 3 Cases recorded in percentages `r casesstarts` (legend as Fig. 2)](img/state06.svg)
  
![Fig. 4 Cumulative cases and Forecast of COVID-19 cases in Nigeria `r forcaststarts`](img/state10.svg)
